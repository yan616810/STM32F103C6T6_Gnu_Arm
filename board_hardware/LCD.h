...
#define LCD_RES_CLR()   GPIO_ResetBits(GPIOB, GPIO_Pin_0)
#define LCD_DC_SET()    GPIO_SetBits(GPIOB, GPIO_Pin_1)
#define LCD_DC_CLR()    GPIO_ResetBits(GPIOB, GPIO_Pin_1)
#define LCD_CS1_SET()   GPIO_SetBits(GPIOB, GPIO_Pin_5)
#define LCD_CS1_CLR()   GPIO_ResetBits(GPIOB, GPIO_Pin_5)
